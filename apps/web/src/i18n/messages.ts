...
const ru = {
  ...
  "auth.signup.subtitle": "Создайте workspace через email или Telegram.",
...
const en: Record<BaseTranslationKey, string> = {
  ...
  "auth.signup.subtitle": "Create a workspace with email or Telegram.",
  ...
  "auth.email.unavailable": "Email sign-in is temporarily unavailable",
